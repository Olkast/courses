...
function startwatch() {
    ...
    watch(['app/images/**/*', '!app/images/dest'], series (images, convertImgtoWebp));
}
...
exports.build = series(cleandist, html, stylesBuild, scriptsMin, imagesMin, convertImgtoWebp, buildcopy);
// Экспортируем дефолтный таск с нужным набором функций
exports.default = parallel(html, styles, scripts, images, convertImgtoWebp, browsersync, startwatch);